...
if (MSVC)
    ...
    message("HAS_IMGUI_DIRECTX_9_X64 ${HAS_IMGUI_DIRECTX_9_X64}")
    message("IMGUI_DIRECTX_9_X64_INCLUDE_DIR ${IMGUI_DIRECTX_9_X64_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_9_X64_LIBRARIES ${IMGUI_DIRECTX_9_X64_LIBRARIES}")
    message("IMGUI_DIRECTX_9_X86_INCLUDE_DIR ${IMGUI_DIRECTX_9_X86_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_9_X86_LIBRARIES ${IMGUI_DIRECTX_9_X86_LIBRARIES}")
    message("IMGUI_DIRECTX_9_X64_LIB_DIR ${IMGUI_DIRECTX_9_X64_LIB_DIR}")
    message("IMGUI_DIRECTX_9_X86_LIB_DIR ${IMGUI_DIRECTX_9_X86_LIB_DIR}")

    message("HAS_IMGUI_DIRECTX_10_X64 ${HAS_IMGUI_DIRECTX_10_X64}")
    message("IMGUI_DIRECTX_10_X64_INCLUDE_DIR ${IMGUI_DIRECTX_10_X64_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_10_X64_LIBRARIES ${IMGUI_DIRECTX_10_X64_LIBRARIES}")
    message("IMGUI_DIRECTX_10_X86_INCLUDE_DIR ${IMGUI_DIRECTX_10_X86_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_10_X86_LIBRARIES ${IMGUI_DIRECTX_10_X86_LIBRARIES}")
    message("IMGUI_DIRECTX_10_X64_LIB_DIR ${IMGUI_DIRECTX_10_X64_LIB_DIR}")
    message("IMGUI_DIRECTX_10_X86_LIB_DIR ${IMGUI_DIRECTX_10_X86_LIB_DIR}")

    message("HAS_IMGUI_DIRECTX_11_X64 ${HAS_IMGUI_DIRECTX_11_X64}")
    message("IMGUI_DIRECTX_11_X64_INCLUDE_DIR ${IMGUI_DIRECTX_11_X64_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_11_X64_LIBRARIES ${IMGUI_DIRECTX_11_X64_LIBRARIES}")
    message("IMGUI_DIRECTX_11_X86_INCLUDE_DIR ${IMGUI_DIRECTX_11_X86_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_11_X86_LIBRARIES ${IMGUI_DIRECTX_11_X86_LIBRARIES}")
    message("IMGUI_DIRECTX_11_X64_LIB_DIR ${IMGUI_DIRECTX_11_X64_LIB_DIR}")
    message("IMGUI_DIRECTX_11_X86_LIB_DIR ${IMGUI_DIRECTX_11_X86_LIB_DIR}")

    message("HAS_IMGUI_DIRECTX_12_X64 ${HAS_IMGUI_DIRECTX_12_X64}")
    message("IMGUI_DIRECTX_12_X64_INCLUDE_DIR ${IMGUI_DIRECTX_12_X64_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_12_X64_LIBRARIES ${IMGUI_DIRECTX_12_X64_LIBRARIES}")
    message("IMGUI_DIRECTX_12_X86_INCLUDE_DIR ${IMGUI_DIRECTX_12_X86_INCLUDE_DIR}")
    message("IMGUI_DIRECTX_12_X86_LIBRARIES ${IMGUI_DIRECTX_12_X86_LIBRARIES}")
    message("IMGUI_DIRECTX_12_X64_LIB_DIR ${IMGUI_DIRECTX_12_X64_LIB_DIR}")
    message("IMGUI_DIRECTX_12_X86_LIB_DIR ${IMGUI_DIRECTX_12_X86_LIB_DIR}")
endif ()
